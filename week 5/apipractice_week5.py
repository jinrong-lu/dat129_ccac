...
def trans(url):
    ...
    #for p in csv_proposals:
        ...
        #for keywords in open('keywords.txt', newline='\n'):
            #for key in keywords:
                #csv_values+= p[key]
#Thank you for your help, Jinrong!

if __name__ == '__main__':
    readFile()
    trans('https://api.donorschoose.org/common/json_feed.html?snacks-for-better-testing/4653507/&APIKey=DONORSCHOOSE&showSynopsis=true&max=50')
    getAverage('https://api.donorschoose.org/common/json_feed.html?snacks-for-better-testing/4653507/&APIKey=DONORSCHOOSE&showSynopsis=true&max=50')
